    ...
    <section id="posts">
        <div class="app-container my-4">
            <div class="container">
                ...
                <p class="margin-30px-bottom sm-margin-20px-bottom">Seminar juga merekomendasikan:</p>
                <ol class="ml-3">
